...
from app.api import alerts, analysis, auth as auth_api, backtest, daily_pro_import, data, ext_data, financial_import, financials, indices, intraday, kline, market_recap, minute_import, monitor_rules, overview, pipeline, rps, screener, settings as settings_api, signals, stock_analysis, stock_pools, strategy, watchlist
...
app.include_router(daily_pro_import.router)
app.include_router(financial_import.router)
app.include_router(minute_import.router)
