...
def test_repository_reads_standard_minute_partition_directly(tmp_path) -> None:
    ...
    daily_frames = list(repo.iter_minute_days(["600000.SH"], date(2026, 1, 5), date(2026, 1, 5)))
    assert len(daily_frames) == 1
    assert daily_frames[0][1]["symbol"].to_list() == ["600000.SH"]
